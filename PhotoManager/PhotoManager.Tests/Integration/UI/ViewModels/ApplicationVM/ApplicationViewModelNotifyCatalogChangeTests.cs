...
public class ApplicationViewModelNotifyCatalogChangeTests
{
    ...
    public void SetUp()
    {
        ...
        _asset1Temp = AssetBuilder.Create()
            .WithFolderPath("", Guid.Empty) // Initialised later
            .WithFileName(FileNames.IMAGE_1_DUPLICATE_COPIED_JPG)
            .WithPixels(PixelWidthAsset.IMAGE_1_DUPLICATE_COPIED_JPG, PixelHeightAsset.IMAGE_1_DUPLICATE_COPIED_JPG,
                ThumbnailWidthAsset.IMAGE_1_DUPLICATE_COPIED_JPG, ThumbnailHeightAsset.IMAGE_1_DUPLICATE_COPIED_JPG)
            .WithFileProperties(FileSize.IMAGE_1_DUPLICATE_COPIED_JPG, DateTime.Now, ModificationDate.Default)
            .WithThumbnailCreationDateTime(DateTime.Now)
            .WithRotation(ImageRotation.Rotate0)
            .WithHash(Hashes.IMAGE_1_DUPLICATE_COPIED_JPG)
            .WithCorrupted(false, null)
            .WithRotated(false, null)
            .Build();
        _asset2Temp = AssetBuilder.Create()
            .WithFolderPath("", Guid.Empty) // Initialised later
            ...
            .WithRotated(false, null)
            .Build();
        _asset3Temp = AssetBuilder.Create()
            .WithFolderPath("", Guid.Empty) // Initialised later
            ...
            .WithFileProperties(FileSize.HOMER_GIF, DateTime.Now, ModificationDate.Default)
            .WithThumbnailCreationDateTime(DateTime.Now)
            .WithRotation(ImageRotation.Rotate0)
            ...
            .WithRotated(false, null)
            .Build();
        _asset4Temp = AssetBuilder.Create()
            .WithFolderPath("", Guid.Empty) // Initialised later
            .WithFileName(FileNames.HOMER_JPG)
            .WithPixels(PixelWidthAsset.HOMER_JPG, PixelHeightAsset.HOMER_JPG,
            ...
            .WithRotated(false, null)
            .Build();
        _asset5Temp = AssetBuilder.Create()
            .WithFolderPath("", Guid.Empty) // Initialised later
            .WithFileName(FileNames.HOMER_DUPLICATED_JPG)
            .WithPixels(PixelWidthAsset.HOMER_DUPLICATED_JPG, PixelHeightAsset.HOMER_DUPLICATED_JPG,
                ThumbnailWidthAsset.HOMER_DUPLICATED_JPG, ThumbnailHeightAsset.HOMER_DUPLICATED_JPG)
            .WithFileProperties(FileSize.HOMER_DUPLICATED_JPG_CURRENT_OS, DateTime.Now, DateTime.Now)
            .WithThumbnailCreationDateTime(DateTime.Now)
            .WithRotation(ImageRotation.Rotate0)
            .WithHash(Hashes.HOMER_DUPLICATED_JPG_CURRENT_OS)
            .WithCorrupted(false, null)
            .WithRotated(false, null)
            .Build();
    }
    ...
    public async Task NotifyCatalogChange_AssetsAndRootCatalogFolderExists_NotifiesChanges(bool analyseVideos)
    {
        ...
        NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, 1, foldersInRepository, assetsDirectory,
            ref increment);
    ...
    public async Task NotifyCatalogChange_AssetsImageAndVideosAndRootCatalogFolderExists_NotifiesChanges()
    {
        ...
        try
        {
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidityAndImageData(assetsFromRepository,
                expectedAssets, assetPathsAfterSync, expectedDirectories, expectedFolders);
            ...
            NotifyCatalogChangeFolderCreated(catalogChanges, folders.Count, foldersInRepository,
            ...
            AssertObservableAssets(firstFrameVideosDirectory, folderToAssetsMapping[videoFirstFrameFolder!],
                _applicationViewModel!.ObservableAssets);
            CheckInstance(
                applicationViewModelInstances,
                firstFrameVideosDirectory,
            ...
            Assert.That(notifyPropertyChangedEvents[27], Is.EqualTo("CurrentFolderPath"));
        ...
        NotifyCatalogChange_AssetsImageAndVideosAndAnalyseVideosIsFalseAndRootCatalogFolderExists_NotifiesChanges()
    {
        ...
        try
        {
            ...
            {
                CatalogAssetsAsyncAsserts.AssertAssetPropertyValidityAndImageData(assetsFromRepository[i],
                    expectedAssets[i], assetPathsAfterSync[i], expectedDirectories[i], expectedFolders[i]);
            }
        ...
        bool analyseVideos)
    {
        ...
        try
        {
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidity(assetsFromRepository,
                expectedAssetsUpdated, assetPathsUpdated, assetsDirectory, folder!);

            Asset assetsFromRepository1 = assetsFromRepository.First(x => x.FileName == _asset1!.FileName);
            Assert.That(assetsFromRepository1.ImageData, Is.Not.Null);

            Asset assetsFromRepository2 = assetsFromRepository.First(x => x.FileName == _asset2!.FileName);
            Assert.That(assetsFromRepository2.ImageData, Is.Not.Null);

            Asset assetsFromRepository3 = assetsFromRepository.First(x => x.FileName == _asset3!.FileName);
            Assert.That(assetsFromRepository3.ImageData, Is.Not.Null);

            Asset assetsFromRepository4 = assetsFromRepository.First(x => x.FileName == _asset4!.FileName);
            Assert.That(assetsFromRepository4.ImageData, Is.Not.Null);

            Asset assetsFromRepository5 = assetsFromRepository.First(x => x.FileName == _asset1Temp!.FileName);
            Assert.That(assetsFromRepository5.ImageData, Is.Null);
            ...
            NotifyCatalogChangeAssetUpdated(catalogChanges, assetsDirectory, assetsDirectory, expectedAssetsUpdated,
                _asset1Temp, folder!, ref increment);
            NotifyCatalogChangeFolderInspectionCompleted(catalogChanges, assetsDirectory, ref increment);
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(51));
            Assert.That(notifyPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[3], Is.EqualTo("CanGoToPreviousAsset"));
            ...
            Assert.That(notifyPropertyChangedEvents[49], Is.EqualTo("StatusMessage"));
    ...
    public async Task NotifyCatalogChange_AssetsAndRootCatalogFolderExistsAndOneVideoIsUpdated_NotifiesChanges()
    {
        ...
        try
        {
            ...
            Asset assetsFromRepository1 = assetsFromRepository.First(x => x.FileName == _asset3Temp!.FileName);
            Assert.That(assetsFromRepository1.ImageData, Is.Not.Null);

            Asset assetsFromRepository2 = assetsFromRepository.First(x => x.FileName == _asset2Temp!.FileName);
            Assert.That(assetsFromRepository2.ImageData, Is.Not.Null);

            Asset assetsFromRepository3 = assetsFromRepository.First(x => x.FileName == _asset4Temp!.FileName);
            Assert.That(assetsFromRepository3.ImageData, Is.Null);
            ...
            Assert.That(notifyPropertyChangedEvents[26], Is.EqualTo("CurrentFolderPath"));
            ...
            Assert.That(notifyPropertyChangedEvents[33], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[34], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[35], Is.EqualTo("ObservableAssets"));
        ...
        NotifyCatalogChange_AssetsAndRootCatalogFolderExistsAndOneVideoIsUpdatedAndAnalyseVideosIsFalse_NotifiesChanges()
    {
        ...
        try
        {
            ...
            for (int i = 0; i < assetsFromRepository.Count; i++)
            {
                CatalogAssetsAsyncAsserts.AssertAssetPropertyValidity(assetsFromRepository[i], expectedAssets[i],
                    assetPathsAfterSync[i], expectedDirectories[i], expectedFolders[i]);
            }
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(35));
            Assert.That(notifyPropertyChangedEvents[21], Is.EqualTo("CurrentFolderPath"));
            ...
            Assert.That(notifyPropertyChangedEvents[27], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[28], Is.EqualTo("CurrentFolderPath"));
            ...
            bool analyseVideos)
    {
        ...
        try
        {
            ...
            Asset assetsFromRepository1 = assetsFromRepository.First(x => x.FileName == _asset2Temp!.FileName);
            Assert.That(assetsFromRepository1.ImageData, Is.Not.Null);

            Asset assetsFromRepository2 = assetsFromRepository.First(x => x.FileName == _asset3Temp!.FileName);
            Assert.That(assetsFromRepository2.ImageData, Is.Null);
        ...
        bool analyseVideos)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < assetsFromRepository.Count; i++)
            {
                CatalogAssetsAsyncAsserts.AssertAssetPropertyValidity(assetsFromRepository[i], expectedAssetsUpdated[i],
        ...
        bool analyseVideos)
    {
        ...
        try
        {
            ...
            AssertCurrentAssetPropertyValidity(assetsFromRepository, expectedAssetsUpdated, assetPathsUpdated,
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(46));
            Assert.That(notifyPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[3], Is.EqualTo("CanGoToPreviousAsset"));
            ...
            Assert.That(notifyPropertyChangedEvents[44], Is.EqualTo("StatusMessage"));
        ...
        bool analyseVideos)
    {
        ...
        try
        {
            ...
            List<string> assetPathsAfterSecondSync =
                [imagePath1, imagePath2, imagePath3, imagePath4, destinationFilePathToCopy];
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidityAndImageData(assetsFromRepository,
                expectedAssetsFirstSync, assetPaths, assetsDirectory, folder!);

            Dictionary<Folder, List<Asset>> folderToAssetsMappingFirstSync =
                new() { { folder!, expectedAssetsFirstSync } };
            ...
            AssertCurrentAssetPropertyValidity(assetsFromRepository, expectedAssetsSecondSync, assetPathsAfterFirstSync,
                assetsDirectory, folder!);

            Dictionary<Folder, List<Asset>> folderToAssetsMappingSecondSync =
                new() { { folder!, expectedAssetsSecondSync } };
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidity(assetsFromRepository,
                expectedAssetsThirdSync, assetPathsAfterSecondSync, assetsDirectory, folder!);
            ...
            Dictionary<Folder, List<Asset>> folderToAssetsMappingThirdSync =
                new() { { folder!, expectedAssetsThirdSync } };
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(57));
            Assert.That(notifyPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[3], Is.EqualTo("CanGoToPreviousAsset"));
            ...
            Assert.That(notifyPropertyChangedEvents[54], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[55], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[56], Is.EqualTo("StatusMessage"));
            ...
            bool analyseVideos)
    {
        ...
        try
        {
            ...
            AssertCurrentAssetPropertyValidity(assetsFromRepository, expectedAssets, assetPaths,
                assetsDirectory, folder!);
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(35)); // unchanged from first sync
            Assert.That(notifyPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[3], Is.EqualTo("CanGoToPreviousAsset"));
        ...
        bool analyseVideos)
    {
        ...
        try
        {
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidityAndImageData(assetsFromRepository,
                expectedAssets, assetPaths, expectedDirectories, expectedFolders);

            List<Folder> folders = [folder1!, folder2!];
            Dictionary<Folder, List<Asset>> folderToAssetsMapping = new()
                { { folder1!, [_asset1, _asset2, _asset3, _asset4] }, { folder2!, [_asset1Temp] } };
            ...
            NotifyCatalogChangeFolderCreated(catalogChanges, folders.Count, foldersInRepository, tempDirectory,
                ref increment);
            NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, folders.Count, foldersInRepository,
                tempDirectory, ref increment);
            ...
            AssertCurrentAssetPropertyValidity(assetsFromRepository, expectedAssetsUpdated, assetPathsUpdated,
                assetsDirectory, folder1!);

            Dictionary<Folder, List<Asset>> folderToAssetsMappingUpdated =
                new() { { folder1!, expectedAssetsUpdated } };
            ...
            bool analyseVideos)
    {
        ...
        try
        {
            ...
            CatalogAssetsAsyncAsserts.AssertAssetPropertyValidityAndImageData(assetsFromRepository[0], _asset2Temp,
                destinationFilePathToCopy1, tempDirectory, folder2!);
            ...
            Dictionary<Folder, List<Asset>> folderToAssetsMappingSecondSync =
                new() { { folder2!, [_asset2Temp, _asset2] } };
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidityAndImageData(assetsFromRepository,
                folderToAssetsMappingSecondSync[folder2!], assetPaths, tempDirectory, folder2!);
            ...
            NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, folders.Count, foldersInRepository,
                tempDirectory,
                ref increment); // Keep the previous events + new sync but same content so no new asset added
            NotifyCatalogChangeAssetCreated(catalogChanges,
                tempDirectory,
                assetsDirectory,
                $"PhotoManager {Constants.VERSION} - {assetsDirectory} - image 0 of 0 - sorted by file name ascending",
        ...
        NotifyCatalogChange_AssetsImageAndVideosAndRootCatalogFolderExistsAndSubDirAndUpdateAndDelete_NotifiesChanges()
    {
        ...
        try
        {
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidityAndImageData(assetsFromRepository,
                expectedAssetsFirstSync, assetPathsAfterSync, expectedDirectories, expectedFolders);
            ...
            NotifyCatalogChangeFolderCreated(catalogChanges, folders.Count, foldersInRepository, imageDeletedDirectory,
                ref increment);
            NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, folders.Count, foldersInRepository,
            ...
            NotifyCatalogChangeFolderCreated(catalogChanges, folders.Count, foldersInRepository, imageUpdatedDirectory,
                ref increment);
            NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, folders.Count, foldersInRepository,
            ...
            NotifyCatalogChangeFolderCreated(catalogChanges, folders.Count, foldersInRepository, subDirDirectory,
                ref increment);
            NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, folders.Count, foldersInRepository,
            ...
            NotifyCatalogChangeFolderCreated(catalogChanges, folders.Count, foldersInRepository, subSubDirDirectory,
                ref increment);
            NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, folders.Count, foldersInRepository,
            ...
            CatalogAssetsAsyncAsserts.AssertAssetsPropertyValidity(assetsFromRepository,
                expectedAssetsSecondSync, assetPathsAfterSync, expectedDirectories, expectedFolders);

            Asset assetsFromRepository1 = assetsFromRepository.First(x => x.FileName == _asset4!.FileName);
            Assert.That(assetsFromRepository1.ImageData, Is.Not.Null);
            ...
            Asset assetsFromRepository4 = assetsFromRepository.First(x => x.FileName == _asset5Temp!.FileName);
            Assert.That(assetsFromRepository4.ImageData, Is.Null);

            Asset assetsFromRepository5 = assetsFromRepository.First(x => x.FileName == _asset2Temp!.FileName);
            Assert.That(assetsFromRepository5.ImageData, Is.Null);
            ...
            Assert.That(_applicationViewModel.ObservableAssets, Has.Count.EqualTo(1));
            AssertObservableAssets(imageUpdatedDirectory, folderToAssetsMappingSecondSync[imageUpdatedFolder!],
                _applicationViewModel!.ObservableAssets);
            CheckInstance(
                applicationViewModelInstances,
                imageUpdatedDirectory,
            ...
            Assert.That(_applicationViewModel.ObservableAssets, Has.Count.EqualTo(1));
            AssertObservableAssets(subDirDirectory, folderToAssetsMappingSecondSync[subDirFolder!],
                _applicationViewModel!.ObservableAssets);
            CheckInstance(
                applicationViewModelInstances,
                subDirDirectory,
            ...
            Assert.That(_applicationViewModel.ObservableAssets, Has.Count.EqualTo(2));
            AssertObservableAssets(firstFrameVideosDirectory, folderToAssetsMappingSecondSync[videoFirstFrameFolder!],
                _applicationViewModel!.ObservableAssets);
            CheckInstance(
                applicationViewModelInstances,
                firstFrameVideosDirectory,
            ...
            Assert.That(_applicationViewModel.ObservableAssets, Has.Count.EqualTo(1));
            AssertObservableAssets(assetsDirectory, folderToAssetsMappingSecondSync[rootFolder!],
                _applicationViewModel!.ObservableAssets);
            CheckInstance(
                applicationViewModelInstances,
                assetsDirectory,
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(84));
            ...
            Assert.That(notifyPropertyChangedEvents[46], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[47], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[48], Is.EqualTo("CurrentAsset"));
            ...
            Assert.That(notifyPropertyChangedEvents[53], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[54], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[55], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[56], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[57], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[58], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[59], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[60], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[61], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[62], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[63], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[64], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[65], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[66], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[67], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[68], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[69], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[70], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[71], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[72], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[73], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[74], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[75], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[76], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[77], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[78], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[79], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[80], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[81], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[82], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[83], Is.EqualTo("AppTitle"));
        }
        finally
        {
            Directory.Delete(assetsDirectory, true);
        ...
        NotifyCatalogChange_AssetsImageAndSameVideosAndRootCatalogFolderExistsAndSubDirAndUpdateAndDelete_NotifiesChanges()
    {
        ...
        try
        {
            ...
            List<string> assetPathsAfterSync =
                [imagePath1ToCopy, imagePath2ToCopy, imagePath3ToCopy, imagePath4ToCopy, firstFramePath1];
            ...
            Asset assetsFromRepository3 = assetsFromRepository.First(x => x.FileName == _asset3Temp!.FileName);
            Assert.That(assetsFromRepository3.ImageData, Is.Null);

            Asset assetsFromRepository4 = assetsFromRepository.First(x => x.FileName == _asset4Temp!.FileName);
            Assert.That(assetsFromRepository4.ImageData, Is.Null);
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(42));
            Assert.That(notifyPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[3], Is.EqualTo("CanGoToPreviousAsset"));
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(82));
            Assert.That(notifyPropertyChangedEvents[42], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[43], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[44], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[45], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[46], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[47], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[48], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[49], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[50], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[51], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[52], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[53], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[54], Is.EqualTo("CurrentAsset"));
            ...
            Assert.That(notifyPropertyChangedEvents[59], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[60], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[61], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[62], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[63], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[64], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[65], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[66], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[67], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[68], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[69], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[70], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[71], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[72], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[73], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[74], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[75], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[76], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[77], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[78], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[79], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[80], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[81], Is.EqualTo("CurrentAsset"));
        }
        finally
        {
            Directory.Delete(assetsDirectory, true);
        ...
        NotifyCatalogChange_AssetsImageAndVideosAndRootCatalogFolderExistsAndSubDirAfterOutputVideoAndUpdateAndDelete_NotifiesChanges()
    {
        ...
        try
        {
            ...
            List<string> assetPathsAfterSync =
                [imagePath1ToCopy, imagePath2ToCopy, imagePath3ToCopy, firstFramePath1, imagePath4ToCopy];
            ...
            List<Folder> expectedFolders =
                [rootFolder!, imageDeletedFolder!, imageUpdatedFolder!, videoFirstFrameFolder!, subDirFolder!];
            List<string> expectedDirectories =
            [
                assetsDirectory, imageDeletedDirectory, imageUpdatedDirectory, firstFrameVideosDirectory,
                subDirDirectory
            ];
            ...
            assetPathsAfterSync =
                [imagePath1ToCopy, firstFramePath1, imagePath4ToCopy, imagePath3ToCopy, firstFramePath2];
            expectedFolders =
                [rootFolder!, videoFirstFrameFolder!, subDirFolder!, imageUpdatedFolder!, videoFirstFrameFolder!];
            expectedDirectories =
            [
                assetsDirectory, firstFrameVideosDirectory, subDirDirectory, imageUpdatedDirectory,
                firstFrameVideosDirectory
            ];
            ...
            Asset assetsFromRepository2 = assetsFromRepository.First(x => x.FileName == _asset4Temp!.FileName);
            Assert.That(assetsFromRepository2.ImageData, Is.Null);

            Asset assetsFromRepository3 = assetsFromRepository.First(x => x.FileName == _asset5Temp!.FileName);
            Assert.That(assetsFromRepository3.ImageData, Is.Null);

            Asset assetsFromRepository4 = assetsFromRepository.First(x => x.FileName == _asset3Temp!.FileName);
            Assert.That(assetsFromRepository4.ImageData, Is.Null);
            ...
            Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(85));
            Assert.That(notifyPropertyChangedEvents[43], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[44], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[45], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[46], Is.EqualTo("CanGoToPreviousAsset"));
            ...
            Assert.That(notifyPropertyChangedEvents[62], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[63], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[64], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[65], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[66], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[67], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[68], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[69], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[70], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[71], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[72], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[73], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[74], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[75], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[76], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[77], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[78], Is.EqualTo("CurrentFolderPath"));
            Assert.That(notifyPropertyChangedEvents[79], Is.EqualTo("AppTitle"));
            Assert.That(notifyPropertyChangedEvents[80], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyPropertyChangedEvents[81], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyPropertyChangedEvents[82], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyPropertyChangedEvents[83], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyPropertyChangedEvents[84], Is.EqualTo("AppTitle"));
        }
        finally
        {
            Directory.Delete(assetsDirectory, true);
    ...
    [TestCase(2)]
    [TestCase(100)]
    public async Task NotifyCatalogChange_NoAssetsAndRootCatalogFolderExists_NotifiesNoAssetChanges(
        int catalogBatchSize)
    {
        ...
        try
        {
            ...
            List<Asset> assetsFromRepositoryByPath =
                _testableAssetRepository.GetCataloguedAssetsByPath(_defaultAssetsDirectory!);
            Assert.That(assetsFromRepositoryByPath, Is.Empty);
            ...
            NotifyCatalogChangeFolderInspectionInProgress(catalogChanges, 1, foldersInRepository,
                _defaultAssetsDirectory!, ref increment);
    ...
    [TestCase(2)]
    [TestCase(100)]
    public async Task NotifyCatalogChange_NoAssetsAndRootCatalogFolderDoesNotExist_NotifiesNoAssetChanges(
        int catalogBatchSize)
    {
        ConfigureApplicationViewModel(catalogBatchSize, _defaultAssetsDirectory!, 200, 150, false, false, false, false);
        ...
        NotifyCatalogChangeFolderDeleted(catalogChanges, 0, foldersInRepository.Length, _defaultAssetsDirectory!,
            ref increment);
        NotifyCatalogChangeFolderInspectionCompleted(catalogChanges, _defaultAssetsDirectory!, ref increment);
        NotifyCatalogChangeBackup(catalogChanges, CatalogAssetsAsyncAsserts.CREATING_BACKUP_MESSAGE, ref increment);
        NotifyCatalogChangeEnd(catalogChanges, ref increment);
    ...
    public async Task NotifyCatalogChange_RootCatalogFolderPointsToAFile_NotifiesNoAssetChanges(bool analyseVideos)
    {
        ...
        NotifyCatalogChangeFolderDeleted(catalogChanges, 0, foldersInRepository.Length, assetsDirectory,
            ref increment);
        NotifyCatalogChangeFolderInspectionCompleted(catalogChanges, assetsDirectory, ref increment);
        NotifyCatalogChangeBackup(catalogChanges, CatalogAssetsAsyncAsserts.CREATING_BACKUP_MESSAGE, ref increment);
        NotifyCatalogChangeEnd(catalogChanges, ref increment);
    ...
    private void NotifyCatalogChangeFolderInspectionInProgress(List<CatalogChangeCallbackEventArgs> catalogChanges,
    ...
    private void NotifyCatalogChangeFolderInspectionCompleted(List<CatalogChangeCallbackEventArgs> catalogChanges,
        string assetsDirectory, ref int increment)
    {
        ...
        _applicationViewModel!.NotifyCatalogChange(catalogChange);
        Assert.That(_applicationViewModel!.StatusMessage,
            Is.EqualTo($"Folder inspection for {assetsDirectory}, subfolders included, has been completed."));
        increment++;
    }

    private void NotifyCatalogChangeFolderCreated(List<CatalogChangeCallbackEventArgs> catalogChanges,
        int expectedFoldersCount, IReadOnlyCollection<Folder> folders, string assetsDirectory, ref int increment)
    {
        CatalogChangeCallbackEventArgs catalogChange = catalogChanges[increment];
        Assert.That(catalogChange.Asset, Is.Null);
    ...
    private void NotifyCatalogChangeFolderDeleted(List<CatalogChangeCallbackEventArgs> catalogChanges,
        int expectedFoldersCount, int foldersCount, string assetsDirectory, ref int increment)
    {
        ...
        _applicationViewModel!.NotifyCatalogChange(catalogChange);
        Assert.That(_applicationViewModel!.StatusMessage,
            Is.EqualTo($"Folder {assetsDirectory} deleted from catalog."));
        increment++;
    }
        ...
        ref int increment)
    {
        ...
        CatalogAssetsAsyncAsserts.AssertAssetPropertyValidity(catalogChange.Asset!, expectedAsset,
            expectedAsset.FullPath, assetsDirectory, folder);
        Assert.That(catalogChange.Folder, Is.Null);
        Assert.That(catalogChange.CataloguedAssetsByPath, Has.Count.EqualTo(expectedAssets.Count));
        AssertCataloguedAssetsByPathPropertyValidity(expectedAssets, catalogChange);
        AssertCataloguedAssetsByPathImageData(expectedAsset, currentDirectory, catalogChange,
            cataloguedAssetsByPathCount);
        ...
        else
        {
            ...
            Assert.That(
                _applicationViewModel!.ObservableAssets
                    .Where(x => string.Equals(x.Folder.Path, catalogChange.Asset.Folder.Path)).ToList(), Is.Empty);
        }

        Assert.That(_applicationViewModel!.StatusMessage,
            Is.EqualTo($"Image {expectedAsset.FullPath} added to catalog."));
        ...
        ref int increment)
    {
        ...
        Assert.That(_applicationViewModel!.StatusMessage,
            Is.EqualTo($"Image {expectedAssetPath} not added to catalog (corrupted)."));
        Assert.That(_applicationViewModel!.AppTitle, Is.EqualTo(expectedAppTitle));
        increment++;
    }
        ...
        ref int increment)
    {
        ...
        Assert.That(_applicationViewModel!.StatusMessage,
            Is.EqualTo($"Image {expectedAsset.FullPath} updated in catalog."));
        Assert.That(_applicationViewModel!.AppTitle,
            Is.EqualTo(
                $"PhotoManager {Constants.VERSION} - {currentDirectory} - image 1 of {expectedAssets.Count} - sorted by file name ascending"));
        increment++;
    }
    ...
    private void NotifyCatalogChangeBackup(List<CatalogChangeCallbackEventArgs> catalogChanges, string expectedMessage,
        ref int increment)
    {
        CatalogChangeReason catalogChangeReason =
            string.Equals(expectedMessage, CatalogAssetsAsyncAsserts.CREATING_BACKUP_MESSAGE)
    ...
    private void NotifyCatalogChangesNoBackupChanges(List<CatalogChangeCallbackEventArgs> catalogChanges,
        ref int increment)
    {
        CatalogChangeCallbackEventArgs catalogChange = catalogChanges[increment];
        Assert.That(catalogChange.Asset, Is.Null);
    ...
    private void NotifyCatalogChangeException(List<CatalogChangeCallbackEventArgs> catalogChanges,
    ...
    private static void AssertCataloguedAssetsByPathPropertyValidity(List<Asset> expectedAssets,
        CatalogChangeCallbackEventArgs catalogChange)
    {
        foreach (Asset cataloguedAssetByPath in catalogChange.CataloguedAssetsByPath)
        {
            ...
            CatalogAssetsAsyncAsserts.AssertAssetPropertyValidity(cataloguedAssetByPath, expectedAsset,
        ...
        int cataloguedAssetsByPathCount)
    {
        if (cataloguedAssetsByPathCount > 0)
        {
            ...
            for (int i = 0; i < cataloguedAssetsByPathCount - 1; i++)
            {
                ...
                else if (!string.Equals(currentDirectory,
                             currentCataloguedAssetsByPath.Folder
                                 .Path)) // All assets in other directories have ImageData null
                {
                    Assert.That(currentCataloguedAssetsByPath.ImageData, Is.Null);
                }
                else
    ...
    {
        if (cataloguedAssetsByPathCount > 0 &&
            string.Equals(currentDirectory, catalogChange.CataloguedAssetsByPath[0].Folder.Path))
        {
            Assert.That(catalogChange.CataloguedAssetsByPath.All(asset => asset.ImageData != null), Is.True);
        }
        else
    ...
    private static void AssertCurrentAssetPropertyValidity(List<Asset> assets, List<Asset> expectedAssets,
        List<string> assetPaths, string folderPath, Folder folder)
    {
        foreach (Asset asset in assets)
        {
            ...
            AssertCurrentAssetPropertyValidity(asset, expectedAsset, assetPath, folderPath, folder);
        }
    }
    ...
    private static void AssertObservableAssets(string currentDirectory, List<Asset> expectedAssets,
