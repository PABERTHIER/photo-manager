...
public class ApplicationViewModelGoToPreviousAssetTests
{
    ...
    [Test]
    public async Task GoToPreviousAsset_CataloguedAssets_GoesToPreviousAsset()
    {
        ...
        Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(49));
        // CatalogAssets + NotifyCatalogChange
        Assert.That(notifyPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
        Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
        Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
    ...
    [Test]
    public async Task GoToPreviousAsset_NoCataloguedAssets_DoesNothing()
    {
