...
public class ApplicationViewModelRemoveAssetsTests
{
    ...
    public async Task RemoveAssets_CataloguedAssets_RemovesAsset()
    {
        ...
        string expectedAppTitle =
            $"PhotoManager {Constants.VERSION} - {assetsDirectory} - image 2 of 2 - sorted by file name ascending";
        ...
        // RemoveAssets
        Assert.That(notifyPropertyChangedEvents[44], Is.EqualTo("ViewerPosition"));
        ...
        Assert.That(notifyPropertyChangedEvents[50], Is.EqualTo("CanGoToPreviousAsset"));
        Assert.That(notifyPropertyChangedEvents[51], Is.EqualTo("CanGoToNextAsset"));
        Assert.That(notifyPropertyChangedEvents[52], Is.EqualTo("CurrentAsset"));
