...
public class FindDuplicatedAssetsViewModelMD5HashTests
{
    ...
    public void SetUp()
    {
        ...
        _asset1 = new()
        {
            ...
            Hash = "a886f237e1cf6da03fb793588fd79b64",
            ImageData = new(),
            Metadata = new()
            {
        ...
        _asset2 = new()
        {
            ...
            ThumbnailCreationDateTime = actualDate,
            ImageRotation = Rotation.Rotate0,
            Hash = "27007861db67443498b6aa0d00808b41",
            ImageData = new(),
            Metadata = new()
            {
                Corrupted = new() { IsTrue = false, Message = null },
        ...
        _asset4 = new()
        {
            ...
            ThumbnailCreationDateTime = actualDate,
            ImageRotation = Rotation.Rotate0,
            Hash = "05d29088572bd5a5970fc370c0ca8751",
            ImageData = new(),
            Metadata = new()
            {
                Corrupted = new() { IsTrue = false, Message = null },
        ...
        _asset5 = new()
        {
            ...
            ThumbnailCreationDateTime = actualDate,
            ImageRotation = Rotation.Rotate0,
            Hash = "d9aa281b55316e10c767877dee265732",
            ImageData = new(),
            Metadata = new()
            {
                Corrupted = new() { IsTrue = false, Message = null },
        ...
        _asset11 = new()
        {
            ...
            ThumbnailCreationDateTime = actualDate,
            ImageRotation = Rotation.Rotate0,
            Hash = "bed3d05d409001724e5f6095c2acaa95",
            ImageData = null,
            Metadata = new()
            {
                Corrupted = new() { IsTrue = false, Message = null },
