...
public class FindDuplicatedAssetsViewModelTests
{
    ...
    public void SetUp()
    {
        ...
        _asset1 = AssetBuilder.Create()
            ...
            .WithFileProperties(FileSize.IMAGE_1_DUPLICATE_JPG,
        ...
        _asset1Temp = AssetBuilder.Create()
            ...
            .WithFileProperties(FileSize.IMAGE_1_JPG,
                FileDatesHelper.GetExpectedCreationDate(ModificationDate.Default), ModificationDate.Default)
            .WithThumbnailCreationDateTime(DateTime.Now)
    ...
    public async Task SetDuplicates_CataloguedAssetsAndOneDuplicatesSet_SetsDuplicates()
    {
        ...
        Assert.That(duplicatedAssetsSets, Has.Length.EqualTo(1));
        Assert.That(duplicatedAssetsSets[0], Has.Length.EqualTo(2));
    ...
    public async Task Refresh_DuplicatesAndPreviousDuplicatedAssetSets_SetsDuplicatedAssetSets()
    {
        ...
        List<DuplicatedSetViewModel> expectedDuplicatedAssetsSets = [duplicatedAssetSet];
        Asset[][] duplicatedAssetsSets = [[_asset2, _asset3]];
        ...
        GetNotExemptedDuplicatedAssets_CataloguedAssetsAndDuplicatesAndOneMatchingDuplicatesInExemptedFolder_ReturnsOtherDuplicatedAssets()
    {
        ...
        try
        {
            ...
            Assert.That(duplicatedAssetsSets, Has.Length.EqualTo(1));
            Assert.That(duplicatedAssetsSets[0], Has.Length.EqualTo(3));
            Assert.That(duplicatedAssetsSets[0].Select(a => a.FileName),
                Is.EquivalentTo(new[] { _asset2!.FileName, _asset3!.FileName, _asset2Temp!.FileName }));
            ...
            Assert.That(notifyApplicationVmPropertyChangedEvents, Has.Count.EqualTo(32));
            // CatalogAssets + NotifyCatalogChange
            Assert.That(notifyApplicationVmPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
            ...
            Assert.That(notifyApplicationVmPropertyChangedEvents[27], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[28], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[29], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[30], Is.EqualTo("StatusMessage"));
        ...
        GetNotExemptedDuplicatedAssets_CataloguedAssetsAndDuplicatesAndTwoSameMatchingDuplicatesInExemptedFolder_ReturnsOtherDuplicatedAsset()
    {
        ...
        try
        {
            ...
            Assert.That(duplicatedAssetsSets, Has.Length.EqualTo(2));

            Asset[] duplicatedAssetsSet1 = duplicatedAssetsSets
                .First(s => s.Any(a => a.FileName == _asset1!.FileName));
            Assert.That(duplicatedAssetsSet1, Has.Length.EqualTo(3));
            ...
            Asset[] duplicatedAssetsSet2 = duplicatedAssetsSets
                .First(s => s.Any(a => a.FileName == _asset2!.FileName));
            Assert.That(duplicatedAssetsSet2, Has.Length.EqualTo(2));
            ...
            Assert.That(notifyApplicationVmPropertyChangedEvents, Has.Count.EqualTo(33));
            // CatalogAssets + NotifyCatalogChange
            Assert.That(notifyApplicationVmPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
            ...
            Assert.That(notifyApplicationVmPropertyChangedEvents[30], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[31], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[32], Is.EqualTo("StatusMessage"));
        ...
        GetNotExemptedDuplicatedAssets_CataloguedAssetsAndDuplicatesAndOneMatchingDuplicateInExemptedFolder_ReturnsOtherDuplicatedAsset()
    {
        ...
        try
        {
            ...
            Asset[] duplicatedAssetsSet1 = duplicatedAssetsSets
                .First(s => s.Any(a => a.FileName == _asset1!.FileName));
            Assert.That(duplicatedAssetsSet1, Has.Length.EqualTo(2));
            Assert.That(duplicatedAssetsSet1.Select(a => a.FileName),
        ...
        GetNotExemptedDuplicatedAssets_CataloguedAssetsAndDuplicatesAndNoAssetsInExemptedFolder_ReturnsEmptyList()
    {
        ...
        try
        {
            ...
            Assert.That(notifyApplicationVmPropertyChangedEvents, Has.Count.EqualTo(31));
            // CatalogAssets + NotifyCatalogChange
            Assert.That(notifyApplicationVmPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationVmPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
    ...
    public async Task CreateDuplicatedAssetSets_CataloguedAssetsAndOneDuplicatesSet_BuildsDuplicatedAssetSets()
    {
        ...
        Assert.That(duplicatedAssetSets, Has.Length.EqualTo(1));
    ...
    private static void AssertDuplicatedAssetsSet(
        DuplicatedSetViewModel duplicatedAssetSet,
        DuplicatedSetViewModel expectedDuplicatedAssetSet)
    {
