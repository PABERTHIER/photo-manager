...
public class MainWindowRefreshAssetsCounterTests
{
    ...
    public async Task RefreshAssetsCounter_CataloguedAssets_RefreshesAssetsCounter()
    {
        ...
        Assert.That(notifyPropertyChangedEvents[29], Is.EqualTo("GlobalAssetsCounterWording"));
        Assert.That(notifyPropertyChangedEvents[30], Is.EqualTo("TotalFilesCountWording"));
