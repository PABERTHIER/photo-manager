...
public class MainWindowToggleImageViewTests
{
    ...
    [Test]
    public async Task ToggleImageView_CataloguedAssetsAndChangePosition_ChangesAppModeAndShowsCurrentImage()
    {
        ...
        Assert.That(notifyPropertyChangedEvents[30], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[31], Is.EqualTo("IsViewerVisible"));
        ...
        Assert.That(notifyPropertyChangedEvents[32], Is.EqualTo("AppTitle"));
        // ChangeAppMode 2
        Assert.That(notifyPropertyChangedEvents[33], Is.EqualTo("AppMode"));
        Assert.That(notifyPropertyChangedEvents[34], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[35], Is.EqualTo("IsViewerVisible"));
        ...
        // ChangeAppMode 3
        Assert.That(notifyPropertyChangedEvents[42], Is.EqualTo("AppMode"));
        Assert.That(notifyPropertyChangedEvents[43], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[44], Is.EqualTo("IsViewerVisible"));
        ...
        Assert.That(notifyPropertyChangedEvents, Has.Count.EqualTo(55));
        // CatalogAssets + NotifyCatalogChange
        Assert.That(notifyPropertyChangedEvents[0], Is.EqualTo("StatusMessage"));
        Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("StatusMessage"));
        Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("ObservableAssets"));
        ...
        Assert.That(notifyPropertyChangedEvents[45], Is.EqualTo("AppTitle"));
        // GoToPreviousAsset
        Assert.That(notifyPropertyChangedEvents[46], Is.EqualTo("ViewerPosition"));
        Assert.That(notifyPropertyChangedEvents[47], Is.EqualTo("CanGoToPreviousAsset"));
        Assert.That(notifyPropertyChangedEvents[48], Is.EqualTo("CanGoToNextAsset"));
        Assert.That(notifyPropertyChangedEvents[49], Is.EqualTo("CurrentAsset"));
        Assert.That(notifyPropertyChangedEvents[50], Is.EqualTo("AppTitle"));
        // ChangeAppMode 4
        Assert.That(notifyPropertyChangedEvents[51], Is.EqualTo("AppMode"));
        Assert.That(notifyPropertyChangedEvents[52], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[53], Is.EqualTo("IsViewerVisible"));
    ...
    [Test]
    public async Task ToggleImageView_NoCataloguedAssets_ChangesAppMode()
    {
