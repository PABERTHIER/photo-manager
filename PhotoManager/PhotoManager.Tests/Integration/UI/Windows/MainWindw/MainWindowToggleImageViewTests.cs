...
public class MainWindowToggleImageViewTests
{
    ...
    public async Task ToggleImageView_CataloguedAssetsAndChangePosition_ChangesAppModeAndShowsCurrentImage()
    {
        ...
        try
        {
            ...
            string expectedAppTitle = $"PhotoManager {Constants.VERSION} - {assetsDirectory} - {_asset1.FileName} - image 1 of 4 - sorted by file name ascending";
            ...
            expectedAppTitle = $"PhotoManager {Constants.VERSION} - {assetsDirectory} - image 3 of 4 - sorted by file name ascending";
