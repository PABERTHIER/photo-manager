...
public class FolderNavigationWindowTests
{
    ...
    public async Task ConstructorAndFolderTreeViewFolderSelectedAndConfirmAndCancel_CataloguedAssets_PerformsCorrectly()
    {
        ...
        try
        {
            ...
            Assert.That(notifyApplicationViewModelPropertyChangedEvents, Has.Count.EqualTo(32));
            ...
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[3], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[4], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[5], Is.EqualTo("CurrentAsset"));
            ...
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[9], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[10], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[11], Is.EqualTo("CurrentAsset"));
            ...
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[14], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[15], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[16], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[17], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[18], Is.EqualTo("AppTitle"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[19], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[20], Is.EqualTo("ObservableAssets"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[21], Is.EqualTo("CanGoToPreviousAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[22], Is.EqualTo("CanGoToNextAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[23], Is.EqualTo("CurrentAsset"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[24], Is.EqualTo("AppTitle"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[25], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[26], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[27], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[28], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[29], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[30], Is.EqualTo("StatusMessage"));
            Assert.That(notifyApplicationViewModelPropertyChangedEvents[31], Is.EqualTo("StatusMessage"));
