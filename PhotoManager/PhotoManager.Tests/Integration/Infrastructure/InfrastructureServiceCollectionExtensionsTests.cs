...
public class InfrastructureServiceCollectionExtensionsTests
{
    ...
    public void AddInfrastructure_RegistersServicesAsSingleton()
    {
        ...
        Assert.That(sqliteConnectionFactoryDescriptor, Is.EqualTo(services[0]));
        ...
        Assert.That(sqliteBackupServiceDescriptor, Is.EqualTo(services[1]));
        ...
        Assert.That(userConfigurationServiceDescriptor, Is.EqualTo(services[3]));
        ...
        Assert.That(pathProviderServiceDescriptor, Is.EqualTo(services[4]));
        ...
        Assert.That(imageMetadataServiceDescriptor, Is.EqualTo(services[7]));
        ...
        Assert.That(assetRepositoryDescriptor, Is.EqualTo(services[8]));
        ...
        Assert.That(assetHashCalculatorServiceDescriptor, Is.EqualTo(services[9]));
