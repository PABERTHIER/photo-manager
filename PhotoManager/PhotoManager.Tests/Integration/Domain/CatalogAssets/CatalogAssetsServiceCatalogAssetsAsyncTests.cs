...
public class CatalogAssetsServiceCatalogAssetsAsyncTests
{
    ...
    // TODO: Case where same video but different folders (one root and one subdir)
    // TODO: Case where FirstFrameFolder is before the other one (like folder is Named zFolder)
    // TODO: Same as CatalogAssetsAsync_AssetsImageAndVideosAndRootCatalogFolderExistsAndSubDirAndUpdateAndDelete_SyncTheAssets but two instances
    // --------------------------------------------------------------------------------------------------------------------------------------------
