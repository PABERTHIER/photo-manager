...
public static class ConfigurationMockExtensions
{
    ...
    {
        // TODO: When one enabled, search for MockGetValue in the code to add it also
        configurationRootMock
             ...
             //.MockGetValue(UserConfigurationKeys.PATH_FIRST_FRAME_VIDEOS, "C:\\Path\\To\\FirstFrameVideos")
             //.MockGetValue(UserConfigurationKeys.PATH_LOCATION, "C:\\Path")
             //.MockGetValue(UserConfigurationKeys.PATH_LOCATION_TO_EXEMPT_THE_FOLDER, "C:\\Path\\To\\FolderExempted")
             //.MockGetValue(UserConfigurationKeys.PATH_BACKUP, "C:\\Path\\To\\Backup")
             ...
             //.MockGetValue(UserConfigurationKeys.BLOBS_PATH_PART, "Blobs")
             //.MockGetValue(UserConfigurationKeys.TABLES_PATH_PART, "Tables")
