...
public class ImageProcessingServiceTests
{
        ...
        ImageRotation rotation, int width, int height)
    {
        ...
        BitmapImageData image =
            (BitmapImageData)_imageProcessingService!.LoadBitmapThumbnailImage(buffer, rotation, width, height);
        ...
        int height, int expectedWidth, int expectedHeight)
    {
        ...
        BitmapImageData image =
            (BitmapImageData)_imageProcessingService!.LoadBitmapThumbnailImage(buffer, width, height);
        ...
        int width, int height, ImageRotation expectedRotation, int expectedWidth, int expectedHeight)
    {
        ...
        BitmapImageData image =
            (BitmapImageData)_imageProcessingService!.LoadBitmapHeicThumbnailImage(buffer, rotation, width, height);
    ...
    public void LoadBitmapHeicThumbnailImage_NegativeWidthAndHeight_ReturnsDefaultBitmapImage()
    {
        ...
        BitmapImageData image =
            (BitmapImageData)_imageProcessingService!.LoadBitmapHeicThumbnailImage(buffer, ImageRotation.Rotate90, -100,
                -100);
    ...
    public void LoadBitmapHeicThumbnailImage_LargeWidthAndHeight_ReturnsDefaultBitmapImage()
    {
        ...
        BitmapImageData image =
            (BitmapImageData)_imageProcessingService!.LoadBitmapHeicThumbnailImage(buffer, rotation, 1000000, 1000000);
    ...
    public void LoadBitmapHeicThumbnailImage_InvalidBuffer_ReturnsDefaultBitmapImage()
    {
        ...
        BitmapImageData image =
            (BitmapImageData)_imageProcessingService!.LoadBitmapHeicThumbnailImage(buffer, rotation, 100, 100);
        ...
        ImageRotation rotation, int expectedWidth, int expectedHeight)
    {
        ...
        BitmapImageData image =
            (BitmapImageData)_imageProcessingService!.LoadBitmapHeicImageFromPath(filePath, rotation);
