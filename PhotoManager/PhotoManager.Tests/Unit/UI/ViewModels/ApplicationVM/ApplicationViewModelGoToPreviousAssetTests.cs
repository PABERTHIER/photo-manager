...
public class ApplicationViewModelGoToPreviousAssetTests
{
    ...
    public void GoToPreviousAsset_ObservableAssetsAndPreviousAsset_GoesToPreviousAsset()
    {
        ...
        try
        {
            ...
            string expectedAppTitle = $"PhotoManager {Constants.VERSION} - {_dataDirectory!} - image 4 of 5 - sorted by file name ascending";
            ...
            expectedAppTitle = $"PhotoManager {Constants.VERSION} - {_dataDirectory!} - image 2 of 5 - sorted by file name ascending";
