...
public class ApplicationViewModelGoToPreviousAssetTests
{
    ...
    public void GoToPreviousAsset_ObservableAssetsAndPreviousAsset_GoesToPreviousAsset()
    {
        ...
        try
        {
            ...
            string expectedAppTitle = $"PhotoManager v1.0.0 - {_dataDirectory!} - image 4 of 5 - sorted by file name ascending";
            ...
            expectedAppTitle = $"PhotoManager v1.0.0 - {_dataDirectory!} - image 2 of 5 - sorted by file name ascending";
