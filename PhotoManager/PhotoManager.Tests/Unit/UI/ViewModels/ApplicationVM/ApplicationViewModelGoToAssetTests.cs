...
public class ApplicationViewModelGoToAssetTests
{
    ...
    public void GoToAsset_AppModeAndAssetIsInCurrentDirectory_ChangesAppModeAndGoesToAsset()
    {
        ...
        try
        {
            ...
            int expectedViewerPosition = 1;
            string expectedAppTitle = $"PhotoManager v1.0.0 - {_dataDirectory!} - {_asset2.FileName} - image 2 of 5 - sorted by file name ascending";
            ...
            // Second GoToAsset
            expectedViewerPosition = 4;
            expectedAppTitle = $"PhotoManager v1.0.0 - {_dataDirectory!} - {_asset5.FileName} - image 5 of 5 - sorted by file name ascending";
