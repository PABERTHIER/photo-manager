...
public class ApplicationViewModelChangeAppModeTests
{
    ...
    public void ChangeAppMode_AssetsAndChangePosition_ChangesAppMode()
    {
        ...
        // ChangeAppMode 1
        Assert.That(notifyPropertyChangedEvents[20], Is.EqualTo("AppMode"));
        Assert.That(notifyPropertyChangedEvents[21], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[22], Is.EqualTo("IsViewerVisible"));
        ...
        Assert.That(notifyPropertyChangedEvents[23], Is.EqualTo("AppTitle"));
        // ChangeAppMode 2
        Assert.That(notifyPropertyChangedEvents[24], Is.EqualTo("AppMode"));
        Assert.That(notifyPropertyChangedEvents[25], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[26], Is.EqualTo("IsViewerVisible"));
    ...
    public void ChangeAppMode_NoAssets_ChangesAppMode()
    {
        ...
        Assert.That(notifyPropertyChangedEvents[1], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[2], Is.EqualTo("IsViewerVisible"));
        ...
        Assert.That(notifyPropertyChangedEvents[5], Is.EqualTo("IsThumbnailsVisible"));
        Assert.That(notifyPropertyChangedEvents[6], Is.EqualTo("IsViewerVisible"));
