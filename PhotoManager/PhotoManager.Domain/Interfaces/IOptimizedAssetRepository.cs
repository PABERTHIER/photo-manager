...
/// <para>
/// This interface replaces <see cref="IAssetRepository"/> in Phase 2.
/// During migration, <see cref="IAssetRepository"/> callers go through an adapter
/// that converts these types to the legacy signatures.
/// </para>
/// </summary>
public interface IOptimizedAssetRepository : IDisposable
{
    // ----------------------------------------------------------------- Events
