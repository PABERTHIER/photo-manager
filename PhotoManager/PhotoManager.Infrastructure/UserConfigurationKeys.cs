...
{
    public const string ANALYZE_VIDEOS = "appsettings:Asset:AnalyseVideos";
    ...
    public const string USING_DHASH = "appsettings:Hash:UsingDHash"; // Enable
    ...
    public const string FFMPEG_PATH = "appsettings:Paths:FfmpegPath"; // in config, remove path notion
    public const string PATH_FIRST_FRAME_VIDEOS = "appsettings:Paths:PathFirstFrameVideos";
    public const string PATH_LOCATION = "appsettings:Paths:PathLocation";
    public const string PATH_LOCATION_TO_EXEMPT_THE_FOLDER = "appsettings:Paths:PathLocationToExemptTheFolder";
    public const string PATH_BACKUP = "appsettings:Paths:PathBackup";
    ...
    public const string BLOBS_PATH_PART = "appsettings:Storage:PathPart:Blobs";
    public const string TABLES_PATH_PART = "appsettings:Storage:PathPart:Tables"; // change path part to better
    ...
    public const string ASSETS_TABLE_NAME = "appsettings:Storage:Tables:AssetsTableName"; // Remove table name and rename Tables to TablesName
