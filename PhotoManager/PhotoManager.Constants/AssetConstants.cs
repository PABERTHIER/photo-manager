...
public static class AssetConstants
{
    ...
    public const int PHashThreshold = 40; //By keeping 40, it can detect a Thumbnail and an original with low quality as duplicates; 5 or 6 is often used as a default value in image comparison libraries
